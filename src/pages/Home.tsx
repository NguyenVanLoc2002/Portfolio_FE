...
export default function Home() {
  ...
  // 👉 makeSparkles now lazy-loads anime too
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      ...
      <div className="relative mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-12 px-6 py-20 md:py-32 lg:grid-cols-2">
        ...
        {/* Right: Profile Card - Removed parallax effect to fix scroll misalignment */}
        <div className="relative z-10 flex items-center justify-center">
          ...
          {/* Profile Card - Fixed position, no scroll transform */}
          <div
            ref={profileCardRef}
      ...
      >
        <div className="fade-in-item text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            3 dự án chính đã triển khai thành công
          </p>
        </div>
          ...
          {[
            {
              ...
              description:
                "Hệ thống thương mại điện tử với kiến trúc Microservices",
            ...
            },
            {
              ...
              description:
                "Ứng dụng ngân hàng với tính năng giao dịch real-time",
            ...
            <div
              key={project.title}
              className="fade-in-item group relative rounded-xl border border-slate-700/50 bg-slate-900/40 p-6 backdrop-blur-xl hover:border-emerald-400/50 transition-all overflow-hidden"
            >
      ...
      >
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div
              key={tech.name}
              className="fade-in-item relative rounded-xl border border-slate-700/50 bg-slate-900/40 p-6 backdrop-blur-xl hover:border-emerald-400/50 transition-all"
            >
      ...
      >
        <div className="fade-in-item relative rounded-2xl border border-slate-700/50 bg-slate-900/40 p-12 backdrop-blur-xl text-center overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-400/5 via-cyan-400/5 to-blue-400/5" />
